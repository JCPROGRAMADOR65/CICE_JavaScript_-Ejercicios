...
pregunta el nombre de la persona sobre la que se quiere datos. Si coincide el nombre con uno de los 
7 en el objeto, mostrar los datos del siguiente modo:

a. Crea un div centrado tanto vertical como horizontalmente en el que aparecerá la foto de la 
persona (picture), seguida de un h1 con el nombre y párrafos para cada uno de los atributos (age, 
email y address). El color de fondo será el color de ojos (eyeColor)
...
// preguntar al usuario lo que quiere hacer.//
let nombre = window.prompt("Introduce un nombre:")

let respuesta = document.createElement("div")//donde almacenamos respuesta//
let encontrado = false //interrumptor logico, cuando recorre todo el ford y no encuentra nada.//
respuesta.classList.add("container")

for (const nombre in personas) { //itera por cada una de las claves dentro de objeto persona, como si fueran indices de un array, pero con claves dentrp de un objeto//
...
document.body.appendChild(respuesta) /* colgamos en la web*/